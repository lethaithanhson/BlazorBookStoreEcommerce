...
namespace BlazorEcommerce.Server.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ServiceResponse<List<Product>>> GetFeaturedProducts()
        {
            ...
            {
                Data = await _context.Products
                    .Where(p => p.Featured && p.Visible && !p.Deleted && p.Category.Visible && !p.Category.Deleted)
        ...
        public async Task<ServiceResponse<List<Product>>> GetProductsAsync()
        {
            ...
            {
                Data = await _context.Products
                    .Where(p => p.Visible && !p.Deleted && p.Category.Visible && !p.Category.Deleted)
        ...
        public async Task<PageList<Product>> GetproductPaging(PagingParameters paging)
        {
