namespace BlazorEcommerce.Server.Services.CategoryService
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<ServiceResponse<List<CategoryResponse>>> GetProductOfCategory()
        {
            ...
            categories.ForEach( c => categoryResponse.Add(new CategoryResponse
            {
                Id = c.Id,
                Name = c.Name,
                TotalProduct = _context.Products.Where(p => p.CategoryId == c.Id && !p.Deleted).Count()
            }));
