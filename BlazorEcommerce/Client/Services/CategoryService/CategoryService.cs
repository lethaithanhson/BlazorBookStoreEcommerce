namespace BlazorEcommerce.Client.Services.CategoryService
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<List<CategoryResponse>> GetProductOfCategory()
        {
            var response = await _http.GetFromJsonAsync<ServiceResponse<List<CategoryResponse>>>("api/Category/admin/productofcategory");
